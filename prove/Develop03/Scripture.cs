...
public class Scripture
{
    ...
    public void hideWords()
    {
        ...
        // keep hidding words until countHiddenWords is bigger than pendingToHide
        while (countHiddenWords < pendingToHide)
        {
            int rIndex = r.Next(_words.Count);
            // hide the word if its not already hide
    ...
    // get scriptrure text with words already hidden 
